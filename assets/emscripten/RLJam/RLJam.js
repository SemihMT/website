...
// include: C:\Users\RUNNER~1\AppData\Local\Temp\tmpw9jztqmb.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = './RLJam.data';
      var REMOTE_PACKAGE_BASE = 'RLJam.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_./RLJam.data');

      };
      Module['addRunDependency']('datafile_./RLJam.data');
    ...
    loadPackage({"files": [{"filename": "/resources/README.txt", "start": 0, "end": 52}, {"filename": "/resources/logo.png", "start": 52, "end": 1388}], "remote_package_size": 1388});

  })();

// end include: C:\Users\RUNNER~1\AppData\Local\Temp\tmpw9jztqmb.js
// include: C:\Users\RUNNER~1\AppData\Local\Temp\tmpvlpymiel.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\RUNNER~1\AppData\Local\Temp\tmpvlpymiel.js
// include: C:\Users\RUNNER~1\AppData\Local\Temp\tmpobvnshee.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\RUNNER~1\AppData\Local\Temp\tmpobvnshee.js
...
var ASM_CONSTS = {
  1074224: () => { if (document.fullscreenElement) return 1; },  
 1074270: () => { return document.getElementById('canvas').width; },  
 1074322: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1074390: () => { document.exitFullscreen(); },  
 1074417: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1074490: () => { if (document.fullscreenElement) return 1; },  
 1074536: () => { return document.getElementById('canvas').width; },  
 1074588: () => { return screen.width; },  
 1074613: () => { document.exitFullscreen(); },  
 1074640: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1074773: () => { return window.innerWidth; },  
 1074799: () => { return window.innerHeight; },  
 1074826: () => { if (document.fullscreenElement) return 1; },  
 1074872: () => { return document.getElementById('canvas').width; },  
 1074924: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1074992: () => { if (document.fullscreenElement) return 1; },  
 1075038: () => { return document.getElementById('canvas').width; },  
 1075090: () => { return screen.width; },  
 1075115: () => { return window.innerWidth; },  
 1075141: () => { return window.innerHeight; },  
 1075168: () => { if (document.fullscreenElement) return 1; },  
 1075214: () => { return document.getElementById('canvas').width; },  
 1075266: () => { return screen.width; },  
 1075291: () => { document.exitFullscreen(); },  
 1075318: () => { if (document.fullscreenElement) return 1; },  
 1075364: () => { return document.getElementById('canvas').width; },  
 1075416: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1075484: () => { document.exitFullscreen(); },  
 1075511: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1075569: () => { return screen.width; },  
 1075594: () => { return screen.height; },  
 1075620: () => { return window.screenX; },  
 1075647: () => { return window.screenY; },  
 1075674: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1075727: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1075798: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1075855: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1076111: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1076182: () => { if (document.fullscreenElement) return 1; },  
 1076228: () => { return window.innerWidth; },  
 1076254: () => { return window.innerHeight; },  
 1076281: () => { if (document.pointerLockElement) return 1; }
};
